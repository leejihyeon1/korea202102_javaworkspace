...
public class LoginForm {
	public static void main(String[] args) {
		...
		p_center.add(la_id);
		p_center.add(t_id);//방위 명시 안하면 디폴트가 센터임 
